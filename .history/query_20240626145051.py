...
LastEditTime: 2024-06-26 14:44:35
...
host_res = session.get(host+'/verifyCode.do?d'+nowTime = str(int(datetime.datetime.now().timestamp()*1000)),headers=headers)
cookie = session.cookies
print(f'cookie:{cookie},dict:{cookie.get_dict()},host:{requests.utils.dict_from_cookiejar(host_res.cookies)}')
