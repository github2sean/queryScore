...
LastEditTime: 2024-06-25 14:47:05
...
def save_image(url, filename):
  ...
  try:
    # 使用 requests 获取图片数据
    response = session.get(url, stream=True,cookies=cookies)
...
print(queryParams)
res = requests.post(host+queryInterface,data=queryParams,cookies=cookies)
