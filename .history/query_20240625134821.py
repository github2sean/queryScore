...
LastEditTime: 2024-06-25 13:47:43
...
cookies = {'JSESSIONID':'JSESSIONID=C81AEE0EC181A487CC01597DA55D1B91'}
...
def save_image(url, filename):
  ...
  try:
    # 使用 requests 获取图片数据
    response = session.get(url, stream=True,headers=headers,cookies=co)
...
print(queryParams)
res = session.post(host+queryInterface,data=queryParams,headers=headers)
