...
LastEditTime: 2024-06-25 22:57:46
...
for stu in stu_list:
	...
	res = requests.post(host+queryInterface,data=queryParams,headers=headers,cookies=c)
  #使用OCR引擎进行文本识别
verifycode=gen_code(name)
queryParams = {'bmh':'246305102696','zkzh':'630508921','sfzh':'511623200812256728','verify':int(verifycode)}
